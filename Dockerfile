...
# Install
RUN apt-get install -y nginx php5-fpm php5-mysql php-apcu php5-imagick php5-imap php5-mcrypt php5-gd libssh2-php php5-memcache php5-memcached php5-curl php5-xcache
